...
use App\Services\Scrapers\TommyHilfiger\TommyHilfigerCategoryScraper;
use App\Services\Scrapers\TommyHilfiger\TommyHilfigerProductDetailScraper;
use App\Services\Scrapers\TommyHilfiger\TommyHilfigerScraperOrchestrator;
use Exception;
use Illuminate\Console\Command;

class TommyHilfigerScrapeCategory extends Command {
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'scrapers:tommyhilfiger:scrape-category
     ...
     * @var string
     */
    protected $description = 'Scrape a Tommy Hilfiger category: collect product URLs and scrape product details.';
    ...
    public function handle () : int {
        ...
        $this->info('Starting Tommy Hilfiger category scraper...');
        ...
        try {
            $website = TommyHilfigerScraperOrchestrator::ensureWebsite();
            ...
            $categoryScraper      = new TommyHilfigerCategoryScraper();
            $productDetailScraper = new TommyHilfigerProductDetailScraper($website);
            $orchestrator         = new TommyHilfigerScraperOrchestrator($categoryScraper, $productDetailScraper, $website);
