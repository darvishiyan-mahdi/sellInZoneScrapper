...
use App\Services\Scrapers\Lululemon\LululemonProductDetailScraper;
use App\Services\Scrapers\Lululemon\LululemonScraperOrchestrator;
use Exception;
use Illuminate\Console\Command;

class LululemonScrapeCategory extends Command {
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'scrapers:lululemon:scrape-category
     ...
     * @var string
     */
    protected $description = 'Scrape a Lululemon category: collect product URLs and scrape product details.';
    ...
    public function handle () : int {
        ...
        $this->info('Starting Lululemon category scraper...');
        ...
        try {
            $website = LululemonScraperOrchestrator::ensureWebsite();
            ...
            $categoryScraper      = new LululemonCategoryScraper();
            $productDetailScraper = new LululemonProductDetailScraper($website);
            $orchestrator         = new LululemonScraperOrchestrator($categoryScraper, $productDetailScraper, $website);
