...
class TommyHilfigerScraperOrchestrator {
    private TommyHilfigerCategoryScraper      $categoryScraper;
    private TommyHilfigerProductDetailScraper $productDetailScraper;
    private Website                         $website;

    public function __construct (
        TommyHilfigerCategoryScraper $categoryScraper, TommyHilfigerProductDetailScraper $productDetailScraper, Website $website
    ) {
    ...
    /**
     * Ensure the Tommy Hilfiger website exists in the database.
     */
    public static function ensureWebsite () : Website {
        $website = Website::where('slug', 'tommy-hilfiger')->first();

        if ( !$website ) {
            $trashedWebsite = Website::withTrashed()->where('slug', 'tommy-hilfiger')->first();
    ...
    public function scrapeCategory (
        ...
        try {
            ...
            Log::info('Starting Tommy Hilfiger category scrape', [
            ...
            Log::info('Tommy Hilfiger category scrape completed successfully', [
                'category_url'                 => $categoryUrl,
                'total_products'               => $totalUrls,
            ...
            Log::error('Tommy Hilfiger category scrape failed', [
                'category_url' => $categoryUrl,
                'error'        => $e->getMessage(),
            ]);
